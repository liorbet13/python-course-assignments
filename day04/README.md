...
### Part 2: WNBA Application Development
5. can you create a new program (with a gui) that wll be updateed based on recent ddata from th wnba website and will allow to vie data on recenet games (boxscore) 
teh website link https://www.wnba.com/https://www.wnba.com/

6. thanks! note on the redme file - can you have the part 2 prompts at the end  (after the notes, and copy my prompts exactly?

7. also add all the prompts i give you to this sectioon until ill tell you to stop

8. can you seperate the buisness logic and the ui to seperate files?/

9. now lets get into details, i want to let the user choose frrom multiple options:
...
10. the data doesnt match, can you make sure to fetch the data from the website i gave you https://www.wnba.com/schedule?season=2025&month=all
even if the most recent game was on may 2025

11. are there any limitations? i see the indiana fever roster is nott good, for example caitlyn clarke isnt there

12. do that for all 13 teams now please

13. we do have some issues here so let's start over and try to creat somehitng else. can you move all files (except the readme) from day04 to a new folder called trying_stuff, and lets start a new project in day04, ill give you the details soon

14. update the prompts in the readme file part to (starting with number 10) from now until ill tell you stop.

15. lets create a new app with a gui.
...
16. i get the confirmation for the fetching, but when i press load it show no player dadtai get the confirmation for the fetching, but when i press load it show no player dadta

17. okay awesome love it. can we display it in a nicer way? instead of a text display can we have  table with all the teams players?

18. any way we can also add a photo for each player ( a small one near their name, from the same website)

19. love it!!! can we change the general apperence (color scheme mostly) to look a little more like the wnbe website? and add the wnba logo?

20. i cant see the wnba logo, do you know why?

21. doesnt work yet bbut i like the orange so thats okay! 
can we add addditional stats for the roster? like ppg or height? and maybe some other useful stats if theyre available

22. great! except the hiehgt college and experience fields are empty, is it fixable?

23. yayyyy it worked! can you epddate the read me file part 2 from the box score app to this one? (dont touch the my prompts section)

24. can you add the team_rosters (the actual fetched data) to gitignore?