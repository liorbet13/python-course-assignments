...
def get_taylor_swift_album(month_source=None):
    ...
    # Use business logic to get album
    album_name = album_logic.get_album_for_month(month_name)
    ...
    if album_name:
        ...
        image_filename = album_logic.get_image_filename_for_album(album_name)
